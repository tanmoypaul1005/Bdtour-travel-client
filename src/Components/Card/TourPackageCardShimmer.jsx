        ...
        <div>
            ...
            <section className="text-gray-700 body-font">
                <div className="container px-2 py-4 flex justify-between ">
                    ...
                    <div className="flex justify-between flex-wrap -m-4 w-[1500px]">
                        ...
                        <div className="p-4 md:w-1/3">
                            <div className="h-full border-2 border-gray-200 rounded-lg overflow-hidden">
                                ...
                                <div className="p-6">
                                    ...
                                    <p className="leading-relaxed mb-3 w-1/2 h-3 animate-pulse bg-gray-400"></p>
                                    <div className="flex items-center flex-wrap ">
                                        <div class="bg-indigo-300 h-4 animate-pulse mt-2 w-32 inline-flex items-center md:mb-2 lg:mb-0"></div>
                                        <span className="bg-indigo-300 w-16 mt-2 h-4 animate-pulse mr-3 px-2 inline-flex items-center ml-auto leading-none text-sm pr-5 py-1">
                                        </span>
                                    </div>
                                </div>
...
export default TourPackageCardShimmer;
